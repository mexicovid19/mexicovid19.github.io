...
d3.json(url, function(json) {
    ...
    mapSvg.selectAll("path")
        ...
        .append("path")
        .attr("d", path)
        .attr('fill', function(d) {return color(d.properties.muertes)})
    ...
    formatMin=d3.timeFormat("%M");
            ...
            navMap.html("<h6>" + d.properties.name + "</h6>"+
                        "<p class='text-danger'> Muertes: "+ d.properties.muertes + "</p>" +
                        "<p class='text-danger'> Muertes por cada 100 mil habitantes: "+ Math.round(d.properties.totales_100k*100)/100 + "</p>" +
                        "<p class='text-warning'> <span style='color:#fd7e14 !important;'>Muertes últimas 24h: "+ d.properties.nuevos + "</span></p>"+
