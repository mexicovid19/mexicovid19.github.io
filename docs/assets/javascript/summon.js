...
var prefix="https://raw.githubusercontent.com/mexicovid19/Mexico-datos/master/data/" 
  urlTotal=prefix+"series_tiempo/covid19_mex_casos_totales.csv",
   ...
   urlMuertes=prefix+"series_tiempo/covid19_mex_muertes.csv",
   urlNuevos=prefix+"series_tiempo/covid19_mex_casos_nuevos.csv",
   urlUpdateTime=prefix+"last_updated.csv";
